                                ...
                                <div class="inner">
                                    <div class="banner-content">
                                        ...
                                        <div class="description">
                                            Check out our new wheel collection!
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="banner">
                            <div class="item-banner style14">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h4 class="tanajil-subtitle">End this weekend</h4>
                            ...
                            <div class="item-banner style12 type2">
                                <div class="inner">
                                    <div class="banner-content">
                                        ...
                                        <div class="description">
                                            Black Car Collections <br/>Summer Lookbook
                                        </div>
      ...
      <!--  <div class="banner-wrapp rows-space-60">
                        ...
                        <div class="banner">
                            <div class="item-banner style6">
                                <div class="inner">
                                    <div class="container">
                                        <div class="banner-content">
                                            <h4 class="tanajil-subtitle">Celebrate Day Sale!</h4>
                                            <h3 class="title">Save <span>25%</span> Of On All<br/>Cars Collection
                                            </h3>
        ...
        <div class="product-in-stock-wrapp">
            <div class="container">
                ...
                <div class="tanajil-product style3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        <div class="banner">
                            <div class="item-banner style10">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h4 class="tanajil-subtitle">Wheel Collection!</h4>
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <div class="banner">
                            <div class="item-banner style11">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h4 class="tanajil-subtitle">Let’s us make your style!</h4>
